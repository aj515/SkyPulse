      ...
      <div className="glass-card-static !rounded-none !rounded-b-2xl px-4 py-3 md:px-6 md:py-4">
        <div className="max-w-7xl mx-auto flex items-center gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="hidden sm:block font-display font-bold text-lg bg-gradient-to-r from-sky-500 to-blue-600 dark:from-sky-400 dark:to-blue-400 bg-clip-text text-transparent">
              {t('app_name')}
            </span>
          </div>
